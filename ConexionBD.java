...
public class ConexionBD{
	...
	ConexionBD(){
		...
		try{
			...
			conexion = DriverManager.getConnection("jdbc:mysql://localhost/northwind?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&autoReconnect=true&useSSL=false&" +"user=root&password=Starwars.97");
